 ...
 */
@WebServlet(name = "Cexam_taken", urlPatterns = {"/Cexam_taken"})
public class Cexam_taken extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) 
        {
            ...
            ArrayList<McandidatePosition> candidatePosition = objCP.GetCandidatePositionByExamState("null");
            ...
            getServletConfig().getServletContext().getRequestDispatcher("/Vexam_taken.jsp").forward(request, response);
        }
    }
